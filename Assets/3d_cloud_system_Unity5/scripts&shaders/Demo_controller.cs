...
public class Demo_controller : MonoBehaviour {
	...
	public GameObject cloud_system5;
	public GameObject cloud_system6;
	public GameObject cloud_system7;
	private GameObject cur_cloud_system;
	// Use this for initialization
	void Start () {
		cur_cloud_system = cloud_system1;
	...
	void OnGUI(){
		...
		GUI.Label(new Rect(10,105,200,20),"Rotation: Right Mous Btn",blStyle);
